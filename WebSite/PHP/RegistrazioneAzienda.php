<?php
session_start();
$dbconn = pg_connect("host=containers-us-west-28.railway.app port=5622 dbname=railway user=postgres password=4jydJNhTKikgVEnDhUlv");
?>
<html>
    <head></head>
<body>
    ...
    else
    {
        ...
        {
          header("Location: errore.php?er=1");
        }
        else
        {
            $user=$_POST['username'];
            ...
            {
              header("Location: errore.php?er=2");
            }  
            else
            {
                ...
                {
                  header("Location: errore.php?er=3");
                }
                else
                {
                  ...
                  {
                    header("Location: errore.php?er=4");
                  }
                  else
                  {
